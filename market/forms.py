...
class RegisterForm(FlaskForm):
    """this will execute while validating. Flaskform search for word validate_ and matches remaining word 
    username to formfield and apply validation there. If error then validationerror will be raised"""
